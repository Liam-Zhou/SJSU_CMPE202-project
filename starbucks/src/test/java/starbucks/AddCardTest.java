...
public class AddCardTest
{
    ...
    public void AddCardTest1()
    {
        ...
        // app.touch(3,5) ;
        // app.touch(1,6) ;
        System.err.println("assapp.screen()"+app.screen());
        ...
        app.touch(3,3);
        app.landscape();
        System.err.println("zylllll1" + app.screenContents());
        app.touch(2,2);
        System.err.println("zylllll2" + app.screenContents());
        app.touch(3,3);
        
        System.err.println("zylllll3" + app.screenContents());
        app.portrait();
        System.err.println("zylllll4" + app.screenContents());
