...
public class Screen implements IScreen, IDisplayComponent
{
    ...
    public ITouchEventHandler getchain() {
    	return chain;
    }

    public ArrayList<IDisplayComponent> getComponents() {
        return components;
    }
    ...
    public String name() {
    	...
    	String name =  (this.getClass().getName()).split("\\.")[1] ;
        return name;
    }

    /**
     * Get screen display content of landscape
     * @return landscape screen content
     */
    @Override
