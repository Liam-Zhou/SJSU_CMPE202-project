...
public class Frame implements IFrame
{
    ...
    private IMenuInvoker AddCard = new MenuOption() ;
    private IMenuInvoker MyCardsOptions = new MenuOption() ;
    private IMenuInvoker MyCardsMoreOptions = new MenuOption() ;
    ...
    public void landscape() {
        if(current instanceof MyCards){
            ((MyCards) current).setLandscape();
    ...
    public void portrait()  {
        // if(current instanceof MyCards){
        //     System.err.println("change to portrait");
        //     ((MyCards) current).setPortrait();
        // }
   ...
   /**
    ...
    public Frame(IScreen initial)
    {
        ...
        portraitStrategy = new IOrientationStrategy() 
        {
            ...
            /** Select Command E */
            public void selectE() { menuE.invoke() ;/** todo **/ }
            
            /** Select Command addcard */
            public void selectAddCard() { AddCard.invoke() ;/** todo **/ }

            /** Select Command mycardsoptions */
			@Override
			public void selectMyCardsOptions() {MyCardsOptions.invoke();}

            /** Select Command mycardsmoreoptions */
			@Override
			public void selectMyCardsMoreOptions() {
				// TODO Auto-generated method stub
				MyCardsMoreOptions.invoke();
			}
        ...
        landscapeStrategy = new IOrientationStrategy() 
        {
           ...
           /**
            ...
            /** Don't Respond in Landscaope Mode */
			@Override
			public void selectMyCardsOptions() {
				// TODO Auto-generated method stub
				//MyCardsOptions.invoke();
			}
    ...
    public void setMenuItem( String slot, IMenuCommand c )
    {
        ...
        if ( "AddCard".equals(slot) ) { AddCard.setCommand(c) ; } 
        if ( "MyCardsOptions".equals(slot) ) { MyCardsOptions.setCommand(c) ; } 
        if ( "MyCardsMoreOptions".equals(slot) ) { MyCardsMoreOptions.setCommand(c) ; } 
    ...
    public void cmd( String c ) 
    {
        ...
        if ( "Add Card".equals(c) ) { selectAddCard() ; }
        if ( "MyCardsOptions".equals(c) ) { selectMyCardsOptions() ; }
        if ( "MyCardsMoreOptions".equals(c) ) { selectMyCardsMoreOptions() ; }
    ...
    /** Select Command addcard */
    public void selectAddCard() { currentStrategy.selectAddCard() ;  }
    
    /** Select Command mycardsoptions */
    public void selectMyCardsOptions() { currentStrategy.selectMyCardsOptions() ;  }
    
    /** Select Command mycardsmoreoptions */
    public void selectMyCardsMoreOptions() { currentStrategy.selectMyCardsMoreOptions() ;  }
